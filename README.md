...
- [x] Describe Middleware?
        ...
        Middleware is the code that is ran on an endpoint or globablly on all endpoint before the code inside the endpoint. Think of an assembly line that performs checks or adds new parts to an item.
